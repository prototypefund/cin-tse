...
class TestExport:
    ...
    def test_wrong_tranaction_type(self):
        ...
        with patch('tse.epson._TSEHost.__init__', return_value=None):
            ...
            with pytest.raises(
                    tse_ex.TSEArgumentTypeError, match='transaction'):
                tse.export(
    ...
    #         tse.login_user('Administrator', TSERole.ADMIN, '12345')
    #         tse.export(Path('/home/lluar/tse.tar.gz'), 'pos456')
    # #
    # #
    #         # tse.login_user('pos456', TSERole.TIME_ADMIN, '54321')
    #         # tse.update_time('pos456', date_time)
    #         # transaction = tse.start_transaction('pos456', 'data', 'type')
    #         # tse.update_transaction('pos456', transaction, 'data', 'type')
    #         # tse.finish_transaction('pos456', transaction, 'data', 'type')
    #
    # #         # print(transaction)
    # #         # print('\n')
    # #         # tse.cancel_export()
